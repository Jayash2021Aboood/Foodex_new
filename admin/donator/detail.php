<?php
  ...
  $pageTitle = lang("Donator Details");
...
<!-- Start All Donator's Donation List  -->
<!-- ================================== -->
...
<main>
    ...
    <!-- Main page content-->
    <?php $all =  getAllDonationsByDonatorID($_GET['id']  != null ? $_GET['id'] : 0); ?>
    <div class="container-fluid px-4">
        <div class="card">
            <div class="card-body">
...
<!-- ================================== -->
<!-- End All Donator's Donation List  -->
