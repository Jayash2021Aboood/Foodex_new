<?php
  ...
  {
    if(isset($_POST['deleteDonator']))
    {
      if(isset($_GET['id']))
      {
        $id = $_POST['id'];
        $delete = deleteDonator($id);
        if($delete ==  true)
        {
  
          $_SESSION["message"] = lang("Donator Deleted successfuly!");          
          $_SESSION["success"] = lang("Donator Deleted successfuly!");          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Donator Details"); ?> <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="type" name="type" type="text" placeholder="<?php echo lang("Type"); ?>"
                                        value="<?php echo $row['type'];?>" readonly />
                                </div>
                                <!-- Form Group (name)-->
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="corporate_field" name="corporate_field" type="text" placeholder="<?php echo lang("Corporate Field"); ?>"
                                        value="<?php echo $row['corporate_field'];?>" readonly />
                                </div>
                                <!-- Form Group (phone)-->
                                <div class="col-md-4 mb-3">
                            ...
                            <!-- Submit button-->
                            <button name="deleteDonator" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
