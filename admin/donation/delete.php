<?php
  ...
  $pageTitle = lang("Delete Donation");
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Donation Details"); ?> <span
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="photo" name="photo" type="text" placeholder="<?php echo lang("Photo"); ?>"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="added_date" name="added_date" type="text" placeholder="<?php echo lang("Added Date"); ?>"
                            ...
                            <!-- Submit button-->
                            <button name="deleteDonation" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
