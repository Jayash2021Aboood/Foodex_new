...
<head>
    ...
    <title><?php echo lang("New Registeration"); ?></title>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11 mt-4">
                            <div class="card text-center h-100">
                                <div class="card-body px-5 pt-5 d-flex flex-column">
                                    <div>
                                        <div class="h3 text-primary"><?php echo lang("Create"); ?></div>
                                        <p class="text-muted mb-4"><?php echo lang("Create an Receiver account to get donations."); ?></p>
                                    </div>
                                ...
                                <div class="card-footer bg-transparent px-5 py-4">
                                    <div class="small text-center"><a class="btn btn-block btn-primary"
                                            href="receiverSignin.php"><?php echo lang("Create new receiver account"); ?></a></div>
                                </div>
                            </div>
                        </div>
                        <!-- Join Organization-->
                        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11 mt-4">
                            <div class="card text-center h-100">
                                <div class="card-body px-5 pt-5 d-flex flex-column align-items-between">
                                    <div>
                                        <div class="h3 text-secondary"><?php echo lang("Join"); ?></div>
                                        <p class="text-muted mb-4"><?php echo lang("Join to us as Donator to provide your servic to community"); ?></p>
                                    </div>
                                ...
                                <div class="card-footer bg-transparent px-5 py-4">
                                    <div class="small text-center"><a class="btn btn-block btn-secondary"
                                            href="donatorSignin.php"><?php echo lang("Join as donator"); ?></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
